...
const schema36 = {"additionalProperties":false,"properties":{"entry":{"type":"string"},"hostKeys":{"default":[],"items":{"enum":["ArrowDown","ArrowUp","Primary+N"],"type":"string"},"maxItems":8,"type":"array","uniqueItems":true}},"required":["entry"],"type":"object"};
...
if(!(((data11 === "ArrowDown") || (data11 === "ArrowUp")) || (data11 === "Primary+N"))){
...
if(!((((((((((data13 === "ui.window") || (data13 === "ui.panel")) || (data13 === "clipboard.write")) || (data13 === "clipboard.read")) || (data13 === "network.https")) || (data13 === "files.userSelected")) || (data13 === "files.index.readAll")) || (data13 === "notifications.publish")) || (data13 === "timer.control")) || (data13 === "background.schedule"))){
