...
const schema35 = {"additionalProperties":false,"properties":{"entry":{"type":"string"},"hostKeys":{"default":[],"items":{"enum":["ArrowDown","ArrowUp","Primary+N"],"type":"string"},"maxItems":8,"type":"array","uniqueItems":true}},"required":["entry"],"type":"object"};
...
if(data5.hostKeys !== undefined){
let data7 = data5.hostKeys;
if(Array.isArray(data7)){
if(data7.length > 8){
const err20 = {instancePath:instancePath+"/panel/hostKeys",schemaPath:"#/$defs/PublicPanelV1/properties/hostKeys/maxItems",keyword:"maxItems",params:{limit: 8},message:"must NOT have more than 8 items"};
if(vErrors === null){
vErrors = [err20];
}
else {
...
const err21 = {instancePath:instancePath+"/panel/hostKeys/" + i0,schemaPath:"#/$defs/PublicPanelV1/properties/hostKeys/items/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err21];
}
else {
...
if(!(((data8 === "ArrowDown") || (data8 === "ArrowUp")) || (data8 === "Primary+N"))){
const err22 = {instancePath:instancePath+"/panel/hostKeys/" + i0,schemaPath:"#/$defs/PublicPanelV1/properties/hostKeys/items/enum",keyword:"enum",params:{allowedValues: schema35.properties.hostKeys.items.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err22];
}
else {
...
j0 = indices0[item0];
const err23 = {instancePath:instancePath+"/panel/hostKeys",schemaPath:"#/$defs/PublicPanelV1/properties/hostKeys/uniqueItems",keyword:"uniqueItems",params:{i: i1, j: j0},message:"must NOT have duplicate items (items ## "+j0+" and "+i1+" are identical)"};
if(vErrors === null){
vErrors = [err23];
}
else {
...
const err24 = {instancePath:instancePath+"/panel/hostKeys",schemaPath:"#/$defs/PublicPanelV1/properties/hostKeys/type",keyword:"type",params:{type: "array"},message:"must be array"};
if(vErrors === null){
vErrors = [err24];
}
else {
...
const err25 = {instancePath:instancePath+"/panel",schemaPath:"#/$defs/PublicPanelV1/type",keyword:"type",params:{type: "object"},message:"must be object"};
if(vErrors === null){
vErrors = [err25];
}
else {
...
if(!((((((((((data10 === "ui.window") || (data10 === "ui.panel")) || (data10 === "clipboard.write")) || (data10 === "clipboard.read")) || (data10 === "network.https")) || (data10 === "files.userSelected")) || (data10 === "files.index.readAll")) || (data10 === "notifications.publish")) || (data10 === "timer.control")) || (data10 === "background.schedule"))){
const err29 = {instancePath:instancePath+"/permissions/" + i2,schemaPath:"#/$defs/PublicPermission/enum",keyword:"enum",params:{allowedValues: schema36.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err29];
}
else {
...
if(!(validate23(data15[i3], {instancePath:instancePath+"/settings/" + i3,parentData:data15,parentDataProperty:i3,rootData,dynamicAnchors}))){
...
const err41 = {instancePath:instancePath+"/supportedPlatforms/" + i4,schemaPath:"#/$defs/PublicPlatform/enum",keyword:"enum",params:{allowedValues: schema40.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err41];
}
else {
