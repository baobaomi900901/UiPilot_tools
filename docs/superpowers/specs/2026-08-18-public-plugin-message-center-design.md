...
> **增量覆盖通知（2026-08-21）：** 本文关于 Windows Toast/托盘适配器所有权、主窗口聚焦时是否
> 抑制原生注意效果、原生副作用派发顺序和声音的合同，已由
> [Windows 原生提醒协调器设计](./2026-08-21-windows-native-attention-design.md) 覆盖。消息持久化、未读、
> 权限、Runtime API、前端徽标和 Messages 页合同继续有效。
